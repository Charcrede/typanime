    ...
    <div className='min-h-screen'>
      {cit ? (
        <TypingGame
          ...
          backHref="/citations"
          breadcrumb={<><span className="bg-white text-primary p-1 border-2 border-white">Citation #{cit.id}</span><span className="border-2 border-white text-white p-1">{cit.author}</span></>}
        />
      ) : (
